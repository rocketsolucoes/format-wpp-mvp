# 🚀 DEPLOY EDGE FUNCTION - Hotmart Webhook

## PASSO 1: Acessar Edge Functions

Abra em nova aba: **https://supabase.com/dashboard/project/tfuexkcmtcootolhuroq/functions**
...
2. Preencha:
   ...
   - **Method:** Deixe como POST (aceita todos)

3. **NÃO clique em Deploy ainda!** Primeiro vamos colar o código.

---

## PASSO 3: Colar o Código da Function

Na área de código, **DELETE todo o código existente** e cole este:
...
2. Aguarde o deploy completar (30-60 segundos)

3. **COPIE A URL GERADA!** Será algo como:
   ```
...
## PASSO 5: Configurar no Hotmart (se ainda não configurou)
...
Após fazer o deploy, **me avise aqui** e cole a URL da function para eu criar os testes!
